...
import { Users, FileText, ShoppingCart, LogOut, Sparkles, TrendingUp, Clock } from 'lucide-react-native';
...
const MedecinHomeScreen = ({ navigation }) => {
  ...
  const [stats, setStats] = useState([
    ...
    { label: 'Commandes', value: '0', icon: ShoppingCart, color: '#F59E0B' },
  ]);
    ...
    const loadStats = async () => {
      try {
        ...
        setStats([
          ...
          { label: 'Commandes', value: commandes.length.toString(), icon: ShoppingCart, color: '#F59E0B' },
        ]);
      } catch (error) {
    ...
    <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.secondaryGrid}>
          ...
          <TouchableOpacity
            style={[styles.secondaryCard, styles.orangeCard]}
            onPress={() => navigation.navigate('Commandes')}
            activeOpacity={0.9}
          >
            <View style={styles.secondaryTop}>
              <View style={styles.secondaryIcon}>
                <ShoppingCart size={24} color="#F59E0B" strokeWidth={2.5} />
              </View>
              <Clock size={16} color="#F59E0B80" strokeWidth={2} />
            </View>
            <Text style={styles.secondaryTitle}>Commandes</Text>
            <Text style={styles.secondarySubtitle}>Suivi en temps réel</Text>
            <View style={styles.secondaryFooter}>
              <Text style={styles.secondaryAction}>Suivre →</Text>
            </View>
          </TouchableOpacity>
        </View>
