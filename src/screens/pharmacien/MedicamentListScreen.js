...
import { Pill, Edit, Trash2, Plus, LogOut, Search, Filter } from 'lucide-react-native';
...
const MedicamentListScreen = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.medicamentCard}>
      <View style={styles.medicamentCardLeft}>
        <View style={styles.avatarContainer}>
          <Text style={styles.avatarText}>M{item.id.slice(-2)}</Text>
        </View>
        <View style={styles.medicamentInfo}>
          <Text style={styles.medicamentName}>{item.nom}</Text>
          <View style={styles.medicamentMeta}>
            <View style={styles.metaBadge}>
              <Text style={styles.metaText}>{item.dosage}</Text>
            </View>
            <View style={styles.metaBadge}>
              <Text style={styles.metaText}>{item.forme}</Text>
            </View>
            <View style={styles.stockBadge}>
              <Text style={styles.stockText}>Stock: {item.quantiteStock}</Text>
            </View>
          </View>
        </View>
      </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View style={styles.countBadge}>
            <Text style={styles.countText}>{medicaments.length}</Text>
          </View>
        </View>
      ...
      <View style={styles.quickAddContainer}>
        ...
        >
          ...
          <Text style={styles.quickAddText}>Nouveau Médicament</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>Ajoutez votre premier médicament</Text>
            <TouchableOpacity
